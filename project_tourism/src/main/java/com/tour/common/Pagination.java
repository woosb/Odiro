...
public class Pagination {
	...
	//생성자
	//Pagination
	public Pagination (int count, int curPage) { //count 총 게시물 수
	...
	public void setPageRange() {
		// where rn BETWEEN #{start} and #{end}
		// 게시물 시작번호 = (현재 페이지 - 1)*페이지당 게시물 수 + 1
	...
	public String toString() {
		return "Pagination [curPage=" + curPage + ", prevPage=" + prevPage + ", nextPage=" + nextPage + ", totPage="
